...
docker run --rm -v "$SAMPL":/work -v "$SAMPL/tools/TalkSHOW":/ts -v /srv/nvme-data/containers/projects/bot:/lw \
...
cp "$SAMPL/output/scene/probe_$LINE.png" /srv/nvme-data/containers/projects/bot/output/probe_$LINE.png
